...
const city = function () {
	...
	const allStreets = [new Street('Ocean Avenue', 1999, 1.1, 'big'), new Street('Evergreen Street', 2008, 2.7, 'small'), new Street('4th Street', 2015, 5.8), new Street('Sunset Boulevard', 1982, 20.5, 'huge')];
